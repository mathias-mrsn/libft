...
void	printf_ft_print_blank(t_options *options, t_argument *arg)
{
	...
	blank = 0;
	if (printf_ft_is_charset(options->conversion, "sc%"))
		printf_ft_print_blank_char(options, &blank);
	else
		printf_ft_print_blank_digit(options, arg, &blank);
